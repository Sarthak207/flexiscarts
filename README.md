...
Project owner / hardware procurement / architecture decisions: you.
Engineering rebuild (Milestones 1–7): built with Claude (Anthropic).

## Legacy

`legacy/webapp/` and `legacy/firebase/` are the original, pre-rebuild prototype pieces, kept for reference and comparison only. They are not part of the current architecture.
